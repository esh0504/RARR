...
# -*- coding: utf-8 -*-
"""
Configuration management module for RainRemover project.
...
class Config(object):
    ...
    def __init__(self, config_yaml: str, config_override: List[Any] = []):
        ...
        self._C.CUDA_DEVICE_ORDER = 'PCI_BUS_ID'
        self._C.SEED = 1234
        self._C.EXP_NAME = 'EXP_NAME'

        self._C.WANDB = CN()
        self._C.WANDB.USE = False
        self._C.WANDB.USER = ''
        self._C.WANDB.APIKEY = ''
        ...
        self._C.DATASET.TRAIN = CN()
        self._C.DATASET.TRAIN.RESUME = False
        self._C.DATASET.TRAIN.DATADIR = 'images_dir/train'
        self._C.DATASET.TRAIN.PS = 64

        self._C.DATASET.VALIDATE = CN()
        self._C.DATASET.VALIDATE.VAL_AFTER_EVERY = 3
        self._C.DATASET.VALIDATE.DATADIR = 'images_dir/train'
        self._C.DATASET.VALIDATE.PS = 64

        self._C.DATASET.TEST = []

        self._C.ROOT = CN()
        self._C.ROOT.DIR = 'checkpoints/models'
        self._C.ROOT.WEIGHT = 'model_best.pth'

        self._C.DATASET.DATA = CN()

        self._C.SAVE = CN()
        self._C.SAVE.DIR = 'checkpoints/results'

        self._C.LOSS = [{'CharbonnierLoss': 1.0}]
